...
最近几年，编程语言领域出现了几个新的佼佼者。当然，你也许并不同意这些语言是 Swift 的合格竞争者。这里我基于个人的看法选了几个编程语言 - 没有按顺序排列。

这些看法可能并不准确。如果你是某个语言的粉丝，并认为我的说法存在错误，想把他们分享到 Twitter。 请别这么做，我只是一个有着某些观点的普通人，而这些观点确实含有一些错误。相反，我们可以利用这些精力来追问问题原由，并改善或解决问题本身。
